...
test('1. firstRecurringArrayElement should return first recurring array element', () => {
...
test('2. firstRecurringArrayElement should return undefined when passed empty array or not an array', () => {
...
test('3. firstRecurringArrayElement should return undefined if all elements are unique', () => {
  expect(firstRecurringArrayElement([2])).toBe(undefined);
  expect(firstRecurringArrayElement(['two'])).toBe(undefined);
});

test('4. firstRecurringArrayElement should not mutate passed in array', () => {
